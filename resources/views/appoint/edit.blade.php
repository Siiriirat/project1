...
<div class="container">
    ...
    <form method="post" action="/appoints/{{$appoint->id}}">
          ...
          <input type="text" id="id_ser" name ="id_ser" style="width:220px;" data-field="date" class="form-control" value="<?php 
          ...
          $('#dtBox').DateTimePicker({
             dateTimeFormat: "yyyy-mm-dd hh:mm:ss"
                    ...
                    {{csrf_field()}}  
                    <br>
                    <button type="submit" class="btn btn-warning"><i class="fa fa-edit"></i> แก้ไข</button>
